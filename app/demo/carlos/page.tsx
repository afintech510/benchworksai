        ...
        <div className="hero">
          <div className="wrap">
            ...
            <div className="hero-stats">
              ...
              <div className="hs"><b>1</b><span data-en="">Partner who owns it with you</span><span data-es="">Socio que lo construye contigo</span></div>
            </div>
          </div>
        </div>
          ...
          <div className="biz">
            <div className="wrap" style={{ paddingTop: 46 }}>
              ...
              <div className="feat-grid">
                ...
                <div className="feat"><div className="ftop"><div className="fic">📞</div><h4 data-en="">VOIP + Missed-Call Text</h4><h4 data-es="">VOIP + Texto Automático</h4></div><p className="what" data-en="">Business line with instant text-back on missed calls and full call logging into the CRM.</p><p className="what" data-es="">Línea de negocio con texto instantáneo en llamadas perdidas y registro en el CRM.</p><div className="why"><b data-en="">Why</b><b data-es="">Por qué</b><span data-en="">A busy shop misses calls all day. Each missed call recovered is a job saved.</span><span data-es="">Un taller ocupado pierde llamadas todo el día. Cada llamada recuperada es un trabajo salvado.</span></div></div>
