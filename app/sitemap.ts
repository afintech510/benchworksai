...
export default function sitemap(): MetadataRoute.Sitemap {
  const pages = [
    ...
    { path: '/services/ai-solutions-architect', priority: 0.9, changeFrequency: 'monthly' as const },
    { path: '/services/prompt-engineering', priority: 0.9, changeFrequency: 'monthly' as const },
    { path: '/services/ai-automation', priority: 0.9, changeFrequency: 'monthly' as const },
