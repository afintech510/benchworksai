...
const GROUPS: { heading: string; rows: LinkRow[] }[] = [
  {
    ...
    rows: [
      ...
      { href: 'https://benchworksai.com/services/websites-platforms', label: 'Service: Websites & Platforms' },
      { href: 'https://benchworksai.com/services/seo', label: 'Service: SEO' },
      { href: 'https://benchworksai.com/services/google-ads', label: 'Service: Google Ads' },
      { href: 'https://benchworksai.com/services/email-sms-marketing', label: 'Service: Email & SMS Marketing' },
      { href: 'https://benchworksai.com/services/business-automation', label: 'Service: Business Automation' },
      { href: 'https://benchworksai.com/services/booking-scheduling', label: 'Service: Booking & Scheduling' },
      { href: 'https://benchworksai.com/services/chatbots-ai-assistants', label: 'Service: Chatbots & AI Assistants' },
      { href: 'https://benchworksai.com/services/ai-education-training', label: 'Service: AI Education & Training' },
